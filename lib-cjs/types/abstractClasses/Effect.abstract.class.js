...
var channels_1 = require("../../core/channels");
var utils_1 = require("../../utils");
var HasOptions_abstract_1 = require("./HasOptions.abstract");
/**
    ...
    function Effect(name, _context, options) {
        ...
        if (name === '_3BandEQ') {
            ...
            _this._updateOptions(__assign({
                ...
                dryWet: 1,
                gain: 1,
                curve: utils_1.makeDistortionCurve(100, _this._context.sampleRate),
                oversample: '2x'
            }, options));
        }
        else if (name === 'Filter') {
