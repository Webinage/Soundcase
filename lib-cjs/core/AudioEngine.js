...
var SoundPlayer_class_1 = require("./SoundPlayer.class");
/**
...
var AudioEngine = /** @class */ (function () {
    ...
    AudioEngine.prototype.createAudioInput = function (audioInputName) {
        this._audioInputs[audioInputName] = new instruments_1.AudioInput(this._masterContext);
        return this._audioInputs[audioInputName];
    };
    /**
     * Summary. (use period)
    ...
    AudioEngine.prototype.createSoundPlayer = function (playerName, sounds, channelName) {
        ...
        this._soundPlayers[playerName] = new SoundPlayer_class_1.SoundPlayer(this._masterContext, sounds, this._channelToConnectNode(channelName));
    ...
    AudioEngine.prototype.createMixChannel = function (channelName) {
        this._mixChannels[channelName] = new channels_1.MixChannel(this._masterContext);
    ...
    AudioEngine.prototype.createChannelStrip = function (name, effects, channelName) {
        ...
        this._channelStrips[name] = new channels_1.ChannelStrip(this._masterContext, effects);
