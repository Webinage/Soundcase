  ...
  render() {
    return (
      <div>
        ...
        <div>
          <label htmlFor="frequency">Frequency : {this.state.frequency}</label><br/>
        ...
        <div>
          <label htmlFor="Q">Q : {this.state.Q}</label><br/>
          <input name="Q" type='range' min="0" max="50" value={this.state.Q} onChange={(event) => this.handleSetQ(event)} />
        </div>
        <div>
          <label htmlFor="filterGain">Gain : {this.state.filterGain}</label><br/>
