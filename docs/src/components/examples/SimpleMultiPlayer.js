  ...
  render() {
    return (
      <div>
        ...
        <div>
          <label htmlFor="drumsVolume">Drums volume : {this.state.drumsVolume}</label><br/>
        ...
        <div>
          <label htmlFor="bassVolume">Bass volume : {this.state.bassVolume}</label><br/>
        ...
        <div>
          <label htmlFor="guitarVolume">Guitar volume : {this.state.guitarVolume}</label><br/>
