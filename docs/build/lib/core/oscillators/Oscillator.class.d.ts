 ...
 */
export declare class Oscillator extends HasOptions<MyOscillatorOptions> {
    private _context;
    private _voices;
    private _output;
    /**
     ...
     */
    constructor(_context: AudioContext, options?: MyOscillatorOptions);
    /**
     * Summary. (use period)
     *
     ...
     * @return {type} Return value description.
     */
    play(input: number | number[] | InternationalNotes | InternationalNotes[]): void;
    /**
     * Summary. (use period)
     *
     * Description. (use period)
