...
var SoundPlayer = /** @class */ (function (_super) {
    ...
    function SoundPlayer(_context, _soundsLibrary, item) {
        ...
        _this._soundsLibrary = _soundsLibrary;
        _this._audioElements = new Map();
        _this._output = new GainNode(_this._context);
        if (item) {
            _this.connect(item);
        }
        else {
            _this.connect(_this._context.destination);
        }
        return _this;
    }
    /**
     ...
     * @return {type} Return value description.
     */
    SoundPlayer.prototype.playSound = function (name, volume) {
        if (volume === void 0) { volume = this._soundsLibrary.get(name).volume; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this._audioElements.get(name)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loadSound(name, volume)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
    ...
    SoundPlayer.prototype.loadSound = function (name, volume) {
        return __awaiter(this, void 0, void 0, function () {
            var sound, htmlAudioElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sound = this._soundsLibrary.get(name);
                        return [4 /*yield*/, this.handleSoundLoading(sound.path)];
                    case 1:
    ...
    SoundPlayer.prototype.handleSoundLoading = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
