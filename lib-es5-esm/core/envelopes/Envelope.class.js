...
var Envelope = /** @class */ (function (_super) {
    ...
    Envelope.prototype.trigger = function () {
        ...
        this.params.forEach(function (param) {
            ...
            if (_this.options.envelopeType === 'exponential') {
                param.param.exponentialRampToValueAtTime(param.maxValue, now + millisecondsToSeconds(clamp(_this.options.attackTime, 0)));
                param.param.exponentialRampToValueAtTime(_this.options.sustainValue, now + millisecondsToSeconds(clamp(_this.options.attackTime + _this.options.decayTime, 0)));
            }
            else {
                param.param.linearRampToValueAtTime(param.maxValue, now + millisecondsToSeconds(clamp(_this.options.attackTime, 0)));
                param.param.linearRampToValueAtTime(_this.options.sustainValue, now + millisecondsToSeconds(clamp(_this.options.attackTime + _this.options.decayTime, 0)));
            }
        });
    };
    /**
    ...
    Envelope.prototype.release = function () {
        ...
        this.params.forEach(function (param) {
            ...
            if (_this.options.envelopeType === 'exponential') {
                param.param.exponentialRampToValueAtTime(clamp(param.minValue, 0.01), now + millisecondsToSeconds(_this.options.releaseTime));
            }
            else {
                param.param.linearRampToValueAtTime(clamp(param.minValue, 0), now + millisecondsToSeconds(_this.options.releaseTime));
            }
        });
    };
    /**
